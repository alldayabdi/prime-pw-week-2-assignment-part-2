...
// We then run a conditional statement whereby if the value of 'name' is equal to Mary, we console log "Hi, Mary"
// But the value of name is not Mary so the 2nd part of the conditional statement is ran and we console log
// 'How do you do'
//
...
// We create two variables 'secret' and 'code' declaring the value of code =123
// A conditional statement is ran whereby if code=123, then the value of secret is super and code is multiplied by
// 2 thus giving us 246
//If the code is greater than 250, the value of secret is 'duper'
// We console log secret and because code===123, we output super.
